        ...
        <div class="login_content">
            ...
            <div class="employee" id="employee">
                ...
                <form action="add_employee_result.php" method="post">
                    ...
                    <br>
                    <input id="e_login" name="e_login" class="login_btn" type="submit" value="Login">
                    <br>
                    <div class="msg">
                    ...
                    <br>
                    <div>
                        <a href="index.php"><button type="button" id="reverse_btn" class="toggle_btn">Go to Admin Panel</button></a>
                    </div>
                </form>
            </div>
        </div>
